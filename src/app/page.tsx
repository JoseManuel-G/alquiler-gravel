    ...
    <main className="min-h-screen bg-[#f7f3ea] text-[#17212b]">
      ...
      <header className="sticky top-0 z-40 border-b border-[#e2d3bd] bg-[#f7f3ea]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm font-semibold text-[#3b4147] lg:flex">
            <a href="#precios" className="hover:text-[#c86f3a]">Precios</a>
            <a href="#rutas" className="hover:text-[#c86f3a]">Rutas</a>
            <Link href="/rutas-gravel-madrid" className="hover:text-[#c86f3a]">Guía rutas</Link>
            <a href="#reserva" className="hover:text-[#c86f3a]">Reservar</a>
            <Link href="/condiciones" className="hover:text-[#c86f3a]">Condiciones</Link>
            <Link href="/contacto" className="hover:text-[#c86f3a]">Contacto</Link>
          </nav>

          <div className="flex items-center gap-3">
            <Link href="/en" className="rounded-full border border-[#d9c7ad] px-4 py-2 text-sm font-black text-[#17212b] transition hover:border-[#c86f3a] hover:text-[#c86f3a]">EN</Link>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 md:grid-cols-2 md:items-center lg:py-28">
          <div className="relative z-10">
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              ...
              <a href="#precios" className="rounded-full border border-[#c8b69d] px-8 py-4 text-center font-black text-[#17212b] transition hover:border-[#c86f3a] hover:text-[#c86f3a]">
                Ver precios
              </a>
            </div>

            <div className="mt-10 grid max-w-xl grid-cols-3 gap-3">
              <div className="rounded-3xl border border-[#e2d3bd] bg-[#fffaf1] p-4 shadow-sm"><p className="text-2xl font-black text-[#c86f3a]">45€</p><p className="mt-1 text-xs text-[#776b5e]">día completo</p></div>
              <div className="rounded-3xl border border-[#e2d3bd] bg-[#fffaf1] p-4 shadow-sm"><p className="text-2xl font-black text-[#c86f3a]">85€</p><p className="mt-1 text-xs text-[#776b5e]">fin de semana</p></div>
              <div className="rounded-3xl border border-[#e2d3bd] bg-[#fffaf1] p-4 shadow-sm"><p className="text-2xl font-black text-[#516b57]">Madrid</p><p className="mt-1 text-xs text-[#776b5e]">rutas gravel</p></div>
            </div>
          </div>
          ...
          <div className="relative z-10 rounded-[2.5rem] border border-[#e2d3bd] bg-[#fffaf1] p-5 shadow-2xl">
            <div className="flex min-h-[470px] flex-col justify-between rounded-[2rem] bg-[#17212b] p-8 text-white">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-black">Asfalto, pistas y aventura cerca de Madrid.</h2>
              </div>
              <div className="rounded-[1.5rem] border border-white/10 bg-white/10 p-6">
                ...
                <p className="mt-2 text-sm leading-6 text-stone-300">Aquí pondremos una imagen real de las bicis con estética outdoor.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-[#e2d3bd] bg-[#fffaf1]">
        <div className="mx-auto grid max-w-7xl gap-4 px-5 py-10 md:grid-cols-4">
          {[["Alquiler flexible", "Medio día, día completo, finde o semana."], ["Bicis revisadas", "Entrega limpia, ajustada y lista para rodar."], ["Rutas recomendadas", "Casa de Campo, El Pardo, Anillo Verde y más."], ["Reserva rápida", "Consulta disponibilidad directa por WhatsApp."]].map(([title, text]) => (
      ...
      <section id="precios" className="mx-auto max-w-7xl px-5 py-20">
        <p className="text-xs font-black uppercase tracking-[0.3em] text-[#c86f3a]">Tarifas</p>
        <h2 className="mt-4 max-w-3xl text-4xl font-black tracking-tight md:text-5xl">Precios sencillos para alquilar gravel en Madrid</h2>
      ...
      <section className="bg-[#17212b] py-20 text-white">
        <div className="mx-auto max-w-7xl px-5">
          <p className="text-xs font-black uppercase tracking-[0.3em] text-[#e6b17e]">Proceso</p>
          <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">Reserva, recoge, rueda y devuelve.</h2>
          <div className="mt-12 grid gap-5 md:grid-cols-4">
            {[["01", "Reserva", "Elige fecha/hora de recogida y devolución."], ["02", "Recoge la bici", "Quedamos en el punto y hora acordados en Madrid."], ["03", "Disfruta la ruta", "Te recomendamos rutas según tu nivel."], ["04", "Devuelve", "Revisamos la bici y liberamos la fianza si todo está correcto."]].map(([number, title, text]) => (
      ...
      <section id="rutas" className="mx-auto max-w-7xl px-5 py-20">
        <p className="text-xs font-black uppercase tracking-[0.3em] text-[#c86f3a]">Rutas</p>
        <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">Rutas gravel recomendadas en Madrid</h2>
        ...
        <Link href="/rutas-gravel-madrid" className="mt-8 inline-flex rounded-full border border-[#c86f3a] px-6 py-3 font-black text-[#c86f3a] transition hover:bg-[#c86f3a] hover:text-white">Ver guía de rutas gravel en Madrid</Link>
      </section>
      ...
      <section className="border-y border-[#e2d3bd] bg-[#fffaf1] py-20">
        <div className="mx-auto max-w-7xl px-5">
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-black tracking-tight md:text-5xl">Bicis gravel para rutas urbanas, campo y sierra</h2>
          <div className="mt-7 max-w-4xl space-y-5 text-lg leading-8 text-[#4f565b]">
            ...
            <p>Desde Madrid puedes hacer rutas gravel por <strong>Casa de Campo</strong>, <strong>El Pardo</strong>, <strong>Madrid Río</strong>, <strong>Anillo Verde Ciclista</strong>, <strong>Moncloa</strong> y conexiones hacia la <strong>Sierra de Madrid</strong>.</p>
            <p>El alquiler puede hacerse por <strong>medio día</strong>, <strong>día completo</strong>, <strong>fin de semana</strong> o <strong>semana</strong>.</p>
          </div>
        </div>
      </section>
      ...
      <section id="reserva" className="mx-auto max-w-7xl px-5 py-20">
        <div className="grid gap-12 md:grid-cols-2 md:items-start">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.3em] text-[#c86f3a]">Reservas</p>
            <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">Solicita disponibilidad para tu próxima ruta.</h2>
            <p className="mt-6 text-lg leading-8 text-[#4f565b]">Indica fecha y hora de recogida, fecha y hora de devolución, altura y zona preferida. El formulario abrirá WhatsApp con tu solicitud preparada.</p>
          </div>
      ...
      <section className="bg-[#17212b] py-20 text-white">
        <div className="mx-auto max-w-7xl px-5">
          ...
          <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">Preguntas frecuentes</h2>
      ...
      <footer className="border-t border-[#e2d3bd] bg-[#f7f3ea]">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-10 text-sm text-[#776b5e] md:flex-row md:items-center md:justify-between">
          <div><p className="font-black text-[#17212b]">Gravel Madrid</p><p className="mt-1">© {new Date().getFullYear()} Alquiler Gravel Madrid.</p></div>
          <div className="flex flex-wrap gap-4"><Link href="/en" className="hover:text-[#c86f3a]">English</Link><Link href="/rutas-gravel-madrid" className="hover:text-[#c86f3a]">Rutas</Link><Link href="/condiciones" className="hover:text-[#c86f3a]">Condiciones</Link><Link href="/privacidad" className="hover:text-[#c86f3a]">Privacidad</Link><Link href="/contacto" className="hover:text-[#c86f3a]">Contacto</Link></div>
        </div>
      </footer>
