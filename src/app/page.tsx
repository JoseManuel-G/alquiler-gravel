  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-black/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <div className="flex items-center gap-3">
            <Link href="/en" className="rounded-full border border-white/15 px-4 py-2 text-sm font-black text-white transition hover:border-green-400 hover:text-green-400">
              EN
            </Link>
          ...
          <div className="relative z-10 rounded-[2rem] border border-white/10 bg-white/[0.06] p-4 shadow-2xl backdrop-blur">
            <div className="flex min-h-[470px] flex-col justify-between rounded-[1.5rem] bg-gradient-to-br from-stone-900 to-black p-8">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-black">Gravel, asfalto, pistas y aventura.</h2>
              </div>
              <div className="rounded-[1.5rem] border border-white/10 bg-black/50 p-6 backdrop-blur">
                ...
                <p className="mt-2 text-sm leading-6 text-stone-400">Aquí pondremos una imagen potente de tus bicis cuando las tengas.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="precios" className="mx-auto max-w-7xl px-5 py-20">
        <p className="text-sm font-black uppercase tracking-[0.3em] text-green-400">Tarifas</p>
      ...
      <section id="rutas" className="mx-auto max-w-7xl px-5 py-20">
        <p className="text-sm font-black uppercase tracking-[0.3em] text-green-400">Rutas</p>
      ...
      <section className="border-y border-white/10 bg-white/[0.03] py-20">
        <div className="mx-auto max-w-7xl px-5">
          <p className="text-sm font-black uppercase tracking-[0.3em] text-green-400">SEO local</p>
          ...
          <div className="mt-7 max-w-4xl space-y-5 text-lg leading-8 text-stone-300">
            ...
            <p>Desde Madrid puedes hacer rutas gravel por <strong>Casa de Campo</strong>, <strong>El Pardo</strong>, <strong>Madrid Río</strong>, <strong>Anillo Verde Ciclista</strong> y conexiones hacia la <strong>Sierra de Madrid</strong>.</p>
      ...
      <section id="reserva" className="mx-auto max-w-7xl px-5 py-20">
        <div className="grid gap-12 md:grid-cols-2 md:items-start">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.3em] text-green-400">Reservas</p>
            <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">Solicita disponibilidad para tu próxima ruta.</h2>
            <p className="mt-6 text-lg leading-8 text-stone-400">Completa el formulario y se abrirá WhatsApp con tu solicitud.</p>
          </div>
      ...
      <footer className="border-t border-white/10 bg-black">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-10 text-sm text-stone-400 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/en" className="hover:text-green-400">English</Link>
